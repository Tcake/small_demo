...
from opends_handelr import jsz_insert, commit, TB_JSZ_ID
from slave import jsz_reader
from log import info
from collision import jsz_collision
from config import config


LOG_NUMBER = config.getint('TB_JSZ', 'r_id')  # 需要设置,总数据行
PRODUCT_QUEUE = Queue(10)
THREAD_NUM = config.getint('TB_JSZ', 'thread_num')
    ...
    while count < 10001:
        ...
        try:
            ...
            if empty_num > 15:
                ...
                empty_num += 1
                continue
        data_result = jsz_collision(data, now_count)
...
def init_readers():
    ...
    for i in xrange(THREAD_NUM):
        reader_list.append(jsz_reader(PRODUCT_QUEUE, i))  # 驾驶证reader
